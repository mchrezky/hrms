...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                ...
                <h3 align= "center" class="text-white mb-4 mt-5"> <?php echo e(__('“ Being together ”')); ?></h3>
                <p class="text-white"> <?php echo e(__('Coming together is a beginning. Keeping together is progress. Working together is success.')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mch8719/public_html/hrmd/resources/views/auth/login.blade.php ENDPATH**/ ?>