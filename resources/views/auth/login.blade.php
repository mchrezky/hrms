    ...
    <div class="row align-items-center text-start">
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                ...
                <h3 align= "center" class="text-white mb-4 mt-5"> {{ __('“ Being together ”') }}</h3>
                <p class="text-white"> {{__('Coming together is a beginning. Keeping together is progress. Working together is success.')}}</p>
            </div>
        </div>
    </div>
</div>
